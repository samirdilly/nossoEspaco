...
(function(factory) {
  ...
  var pluginName = 'bootstrapDualListbox',
    defaults = {
      ...
      filterPlaceHolder: 'Filtro de busca',
      ...
      infoText: 'Autoridades {0}',                                                        // text when all options are visible / false for no info text
      ...
      btnMoveAllText: '<i class="fas fa-forward"></i>',                                                         // string, sets the text for the "Move All" button
      btnRemoveAllText: '<i class="fas fa-backward"></i>'                                                        // string, sets the text for the "Remove All" button
    },
